...
from utils.defines import RESULTS_FOLDER, PROB_KEY, ALGO_KEY, PI_KEY, TERM_KEY, SEEDS_KEY, MOO_KEY
import pandas as pd
...
# 'brkga' is combinatorial algo, has to be run with a combinatorial problem like 'soo_rnd_knp'
...
moo_mixed = {
    ...
    ALGO_KEY: ['nsga2', 'nsga3', 'unsga3'],
    PROB_KEY: ['bnh','ctp1', 'dtlz1', 'dtlz2', 'dtlz3'],
