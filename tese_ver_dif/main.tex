...
% ----------------------------------------------------------------------
\input{other/Preamble.tex} % file "Preamble.tex"
...
%  Cover page
% ----------------------------------------------------------------------
\input{other/FrontCover.tex} % file "FrontCover.tex"
\cleardoublepage
...
\input{other/Nomenclature.tex} % file "Nomenclature.tex"
%
...
\input{Background} % file "Background.tex"
\cleardoublepage

\input{Implementation} % file "Implementation.tex"
\cleardoublepage
...
\bibliographystyle{other/abbrvunsrtnat} % <<<<< SELECT IF USING REFERENCES BY NUMBER (CITATION ORDER)
...
\input{other/Appendix_A.tex} % file "Appendix_A.tex"
\cleardoublepage
